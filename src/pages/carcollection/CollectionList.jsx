...
const categories = ["All", "First Car", "Luxury", "Sedan", "Hatchback", "Safety", "Parents", "SUV", "Driving Pleasure" ];
    ...
    <div className="max-w-6xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        {categories.map((category) => (
          <button
            key={category}
            className={`p-2.5 rounded border transition duration-200 ease-in-out ${
              activeCategory === category
                ? "bg-ButtonColor text-white"
                : "bg-gray-100 hover:bg-ButtonColor hover:text-white"
            }`}
