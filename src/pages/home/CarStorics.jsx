...
const CarStories = () => {
  return (
    <div className="w-full lg:w-10/12 mx-auto p-4 lg:p-0">
      <h2 className="text-2xl font-bold mb-6 text-gray-800">Car Visual Stories</h2>
        ...
        {Cars.map((car, index) => (
          <div
            ...
            <div className="p-4 flex flex-col justify-between h-32">
              <p className="text-sm font-medium text-gray-700 mb-4">{car.name}</p>
              <a
                href={car.link}
                className="text-orange-500 font-semibold flex items-center space-x-1"
              >
