...
import { useElecticCarList } from "../../api/api";
...
const ElectricCars = () => {
  const {electicCarList} = useElecticCarList();
  return (
      ...
      <Carousel responsive={responsive}>
        {electicCarList.map((car, index) => (
          <div key={index} className="bg-white rounded-lg shadow-lg p-4 m-2 ">
            ...
            <p className="text-gray-600 mb-4 text-start">৳ {car.price.toLocaleString("en-IN")} TK</p>
